...
static void POWER_SetLowPowerMode(LPC_LOWPOWER_T *p_lowpower_cfg)
{
    ...
    switch (low_power_mode)
    {
        case LOWPOWER_CFG_LPMODE_DEEPSLEEP:
        {
            ...
            /* Disable autoclockgating on SDMA0 and SDMA1 during DeepSleep*/
            ...
            // CSSV2
            {
                ...
                // #ifdef LPC55S36_SERIES
                //                 if (((SYSCON->PRESETCTRL2 & 0x40000U) == 0) && syscon_css_clk_pclk_hclk)
                // #else
                //                 if (((SYSCON->PRESETCTRL[2] & 0x40000U) == 0) && syscon_css_clk_pclk_hclk)
                // #endif
                //                 {
                //                     /* Restore CSS */
